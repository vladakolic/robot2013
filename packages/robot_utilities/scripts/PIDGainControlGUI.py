...
import roslib; roslib.load_manifest('robot_utilities')
import rospy

from std_msgs.msg import String
from robot_utilities.msg import PIDGains
from robot_utilities.srv import PIDGainControl
...
class Application(tk.Frame):
    ...
    def createWidgets(self):
        ...
        self.KPSpinbox = tk.Spinbox(self, from_=0.0, to=100.0, increment=0.1, values=(350.))
        ...
        self.KISpinbox = tk.Spinbox(self, from_=0.0, to=100.0, increment=0.1, values=(800.))
        ...
        self.KDSpinbox = tk.Spinbox(self, from_=0.0, to=100.0, increment=0.1, values=(10.))
